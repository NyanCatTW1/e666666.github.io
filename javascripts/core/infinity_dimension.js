...
function DimensionPower(tier) {
  ...
  if (ECTimesCompleted("eterc2") !== 0 && tier == 1) mult = mult.times(player.infinityPower.pow(4.5/(700-ECTimesCompleted("eterc2")*100)).times(player.infinityPower.plus(10).log10().pow(1000)).plus(1))
