...
function buyManyInfinityDimension(tier) {
  ...
  dim.cost = new Decimal(infBaseCost[tier]).times(Decimal.pow(infCostMults[tier]/div, (dim.baseAmount/10 + 1)*(ECTimesCompleted("eterc12")?1-ECTimesCompleted("eterc12")*0.008:1)))
